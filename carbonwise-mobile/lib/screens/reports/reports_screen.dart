...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Widget _buildDeviceStatRow(String device, String carbon, String saved) {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
            flex: 2,
            child: Text(device, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
          ),
          Expanded(
            child: Text(carbon, style: const TextStyle(fontSize: 13, color: Colors.white54)),
          ),
          Expanded(
            child: Text(saved, style: const TextStyle(fontSize: 13, color: AppTheme.primaryGreen)),
          ),
        ],
      ),
    );
